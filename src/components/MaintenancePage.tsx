...
import { getMaintenanceModeConfig, getAppConfig, getFooterConfig } from '../services/configService';
...
const MaintenancePage: React.FC = () => {
    ...
    useEffect(() => {
        const loadConfigs = async () => {
            try {
                const [maintenanceConfig, appConfig, footerConfig] = await Promise.all([
                ...
                console.error('Error loading maintenance page configs:', error);
            }
        };
        loadConfigs();
    }, []);
    ...
    const footerText = configs.footer.enabled 
        ? configs.footer.text.replace('{year}', currentYear.toString())
        : null;
        ...
        <div className="dark relative flex flex-col min-h-screen bg-gray-900 overflow-hidden">
            ...
            <main className="relative z-10 flex-grow flex flex-col items-center justify-center p-6 text-center">
                ...
                <div className="flex items-center space-x-3 mb-6">
                    ...
                    <span className="text-2xl font-semibold text-gray-200">{configs.app.title}</span>
                </div>
                ...
                <div className="w-full max-w-2xl bg-gray-800/70 backdrop-blur-lg rounded-2xl shadow-xl border border-gray-700 p-8 sm:p-12">
                    ...
                    <div className="text-base sm:text-lg text-gray-400 prose prose-sm dark:prose-invert max-w-none">
                        <NestedMarkdown content={configs.maintenance.message} />
                    </div>
